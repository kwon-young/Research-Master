...
\begin{figure}[btp]
  \includegraphics[scale=0.7]{list_symbols}
...
\begin{figure}[btp]
  \includegraphics[scale=0.7]{old_score}
...
\begin{figure}[btp]
  \includegraphics[scale=0.16]{old_score_HMM}
...
\begin{figure}[btp]
  \centering
  \includegraphics[scale=0.5]{maurdor}
...
\begin{figure}[bp]
  \centering
  \includegraphics[scale=1]{attention_model}
